...
public class CcsClient {
    ...
    private String mApiKey = "AIzaSyBI56eSACUP_gOou3DuvVMjB_qz5PsKjRo";
    ...
    private CcsClient(String projectId, String apiKey, boolean debuggable) {
        this();
        mApiKey = "AIzaSyBI56eSACUP_gOou3DuvVMjB_qz5PsKjRo";
    ...
    public static void main(String[] args) {
        final String projectId = "67784837939";
        ...
        final String toRegId ="APA91bEP-1SYxopjXNwLKnQjlwU6pGS20hmZFNLHHCFjP_GEY91T1Gqz6553Bl3fjJM-g1DGEQkMsq84MhprToiBZzYvSvYjfwVb_t__fa3rCVXp0WheJJ-jX74NV5ib0xpsc37KrGiD";
